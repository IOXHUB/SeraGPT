                          ...
                          {item.submenu.map((subItem) => (
                            <div key={subItem.name}>
                              ...
                              >
                                ...
                                <svg
                                  className={`w-3 h-3 text-[#1e3237]/40 transition-transform ${expandedSubMenus[subItem.name] ? 'rotate-90' : ''}`}
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
            ...
            {Object.entries(groupedMenuItems).map(([category, items]) => (
              <div key={category} className="mb-6">
                <div className="px-4 mb-3">
                  <h3 className="text-xs font-medium text-[#1e3237]/60 uppercase tracking-wide">{category}</h3>
                </div>
                <div className="space-y-1 px-2">
                  {items.map((item) => (
                    <div key={item.href}>
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {item.submenu && (
                            <svg
                              className={`w-4 h-4 text-[#1e3237]/40 transition-transform ${expandedMenus[item.name] ? 'rotate-90' : ''}`}
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
