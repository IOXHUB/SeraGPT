    ...
    <ClientOnly>
      <div className="flex h-screen bg-[#146448]">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <footer className="fixed bottom-0 left-0 right-0 border-t border-white/10 bg-[#146448] p-4 z-30" style={{paddingLeft: typeof window !== 'undefined' && window.innerWidth >= 1024 ? '256px' : '0px'}}>
