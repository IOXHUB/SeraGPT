        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-16 flex items-center px-4 border-b border-white/10 bg-[#146448]">
            <div className="flex items-center space-x-2">
              <button
                className="lg:hidden p-1 text-white hover:bg-white/10 rounded-lg flex items-center justify-center"
              ...
              <h1 className="text-white font-semibold text-lg leading-none" style={{ lineHeight: '28px' }}>AI Dashboard</h1>
            </div>
          </header>
