    ...
    <DashboardLayout title="Ayarlar" subtitle="Hesap ve uygulama ayarlarınızı yönetin">
      <div className="space-y-6">
        ...
        <div>
          ...
          {activeTab === 'location' && (
            <div className="bg-[#f6f8f9] rounded-xl border border-gray-200 p-6 shadow-lg">
              <h2 className="text-xl font-semibold text-[#1e3237] mb-6">📍 Konum & İşletme Bilgileri</h2>
          ...
          {activeTab === 'preferences' && (
            <div className="bg-[#f6f8f9] rounded-xl border border-gray-200 p-6 shadow-lg">
              <h2 className="text-xl font-semibold text-[#1e3237] mb-6">⚙️ Uygulama Tercihleri</h2>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-[#1e3237] mb-4">Görünüm</h3>
          ...
          {activeTab === 'notifications' && (
            <div className="bg-[#f6f8f9] rounded-xl border border-gray-200 p-6 shadow-lg">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-[#1e3237] mb-4">Bildirim Kanalları</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-[#1e3237] mb-4">Bildirim Türleri</h3>
                  <div className="space-y-4">
                    <label className="flex items-center">
                      <input
                        type="checkbox"
          ...
          {activeTab === 'security' && (
            <div className="bg-[#f6f8f9] rounded-xl border border-gray-200 p-6 shadow-lg">
              <h2 className="text-xl font-semibold text-[#1e3237] mb-6">🔒 Güvenlik Ayarları</h2>
          ...
          {activeTab === 'data' && (
            <div className="bg-[#f6f8f9] rounded-xl border border-gray-200 p-6 shadow-lg">
              <h2 className="text-xl font-semibold text-[#1e3237] mb-6">💾 Veri Yönetimi</h2>
